  ...
  return (
    <section className="w-full py-20">
        <h1 className="heading">
            My <span className="text-violet-100">Approach</span>
        </h1>
...
const AceternityIcon = ({order}:{order: string}) => {
  ...
  <span className="inline-flex h-full w-full cursor-pointer items-center justify-center rounded-full bg-slate-950 px-5 py-2 text-sm  text-white backdrop-blur-3xl lg:text-2xl font-bold ">
    {order}
  </span>
</button></div>
  );
